...
const SearhMovie = () => {
  ...
  const submitHandlete = async (e)=>{
    ...
    try{
      const res = await axios.get(`${Search_Movie}${searchedMovie}&include_adult=false&language=en-US&page=1`, options)
 ...
 {
  searchMovie !== null ? (<MovieList title={movieName} searchMovie = {true} movies={searchMovie}/>):
